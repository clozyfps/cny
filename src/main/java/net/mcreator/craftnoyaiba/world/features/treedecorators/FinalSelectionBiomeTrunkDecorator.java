...
public class FinalSelectionBiomeTrunkDecorator extends TrunkVineDecorator {
	public static Codec<FinalSelectionBiomeTrunkDecorator> CODEC = Codec.unit(FinalSelectionBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("final_selection_biome_tree_trunk_decorator", DECORATOR_TYPE));
	}
