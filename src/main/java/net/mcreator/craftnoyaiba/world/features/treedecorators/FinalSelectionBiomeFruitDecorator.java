...
public class FinalSelectionBiomeFruitDecorator extends CocoaDecorator {
	public static Codec<FinalSelectionBiomeFruitDecorator> CODEC = Codec.unit(FinalSelectionBiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("final_selection_biome_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public FinalSelectionBiomeFruitDecorator() {
		super(0.2f);
	}
