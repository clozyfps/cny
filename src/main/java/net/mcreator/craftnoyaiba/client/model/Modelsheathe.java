...
public class Modelsheathe<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 5).addBox(-2.0F, -2.0F, -0.5F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.3F)),
				PartPose.offsetAndRotation(5.0F, 10.4024F, -2.8551F, 0.0F, -0.3054F, -1.5708F));
		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 18).addBox(-1.0F, -1.0F, -5.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(-0.3F)),
				PartPose.offsetAndRotation(5.0F, 8.976F, -7.4345F, 0.0F, 0.3054F, 1.5708F));
		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 45).addBox(-1.0F, -1.0F, -1.1F, 2.0F, 2.0F, 17.0F, new CubeDeformation(-0.3F)),
