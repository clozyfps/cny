...
public class FinalSelectionOverlayOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		FinalSelectionOverlayDisplayOverlayIngameProcedure.execute(entity)
			...
			FinalSelectionGoalFirstProcedure.execute(entity)
			...
			ShowCompletedFinalSelection1Procedure.execute(entity)
			...
			ShowCompletedFinalSelection2Procedure.execute(entity)
			...
			FinalSelectionGoalNew2Procedure.execute(entity)
