...
public class Modelmuzan_armor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "muzan_armor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(27, 59)
				...
				.addBox(-2.0F, 4.9817F, -2.3136F, 4.0F, 6.0F, 1.0F, new CubeDeformation(0.01F)).texOffs(32, 9)
				.addBox(-4.0F, -0.2683F, -0.9636F, 8.0F, 4.0F, 3.0F, new CubeDeformation(0.12F)).texOffs(0, 16)
		...
		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(24, 0).addBox(-0.5F, -2.0F, -1.5F, 1.0F, 4.0F, 3.0F,
						new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(-3.0435F, 1.4309F, -2.0969F, 0.0F, 0.0F, -0.1745F));

		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -2.0F, -1.5F, 1.0F, 4.0F, 3.0F,
						new CubeDeformation(0.011F)),
				PartPose.offsetAndRotation(3.0435F, 1.4309F, -2.0969F, 0.0F, 0.0F, 0.1745F));

		PartDefinition cube_r4 = Body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(52, 48).addBox(-1.0F, -2.0F, -1.5F, 2.0F, 4.0F, 3.0F,
		...
		PartDefinition cube_r5 = Body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(27, 52).addBox(-1.0F, -2.0F, -1.5F, 2.0F, 4.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.3374F, 1.6388F, -1.2263F, -0.1184F, 0.5639F, -0.1874F));
		...
		PartDefinition cube_r13 = Body.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -5.0F, -1.5F, 8.0F, 6.0F, 3.0F,
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(44, 40)
						.addBox(-0.775F, -2.0183F, -2.0136F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.14F))
						.texOffs(38, 16).addBox(-3.0F, -2.0183F, -2.0136F, 2.0F, 8.0F, 4.0F, new CubeDeformation(0.14F))
						.texOffs(16, 32).addBox(-3.0F, -2.0183F, -2.0136F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.1F))
						.texOffs(44, 28).addBox(-3.0F, 7.7317F, -2.0136F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.09F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition cube_r23 = RightArm.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(28, 44).addBox(-1.5F, -2.0F, -1.5F, 3.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r24 = RightArm.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(42, 48)
						.addBox(-1.5F, -3.5F, -2.0F, 2.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(48, 33)
						.addBox(-1.5F, -3.5F, 0.2421F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.6383F, 4.5528F, -0.1336F, 0.0F, 0.0F, 0.48F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(44, 40).mirror()
						.addBox(-1.225F, -2.0183F, -2.0136F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.14F)).mirror(false)
						.texOffs(38, 16).mirror()
						.addBox(1.0F, -2.0183F, -2.0136F, 2.0F, 8.0F, 4.0F, new CubeDeformation(0.14F)).mirror(false)
		...
		PartDefinition cube_r25 = LeftArm.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(28, 44).mirror()
						.addBox(-1.5F, -2.0F, -1.5F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.5487F, -0.8143F, -0.4763F, 0.0F, 0.0F, -1.4399F));

		PartDefinition cube_r26 = LeftArm.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(42, 48).mirror()
						.addBox(-0.5F, -3.5F, -2.0F, 2.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(48, 33).mirror()
						.addBox(-2.5F, -3.5F, 0.2421F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.6383F, 4.5528F, -0.1336F, 0.0F, 0.0F, -0.48F));
