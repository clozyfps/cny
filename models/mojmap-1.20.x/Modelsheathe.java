...
public class Modelsheathe<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = handle.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -2.0F, -0.5F, 4.0F, 4.0F, 1.0F,
		...
		PartDefinition cube_r2 = handle.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 5).addBox(-2.5296F, -2.5296F, -1.7537F, 4.0F, 4.0F, 1.0F,
						new CubeDeformation(-0.1F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3185F, 0.3035F, 0.7363F));

		PartDefinition cube_r3 = handle.addOrReplaceChild("cube_r3",
